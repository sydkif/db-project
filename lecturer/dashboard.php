                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td style="display:flex; align-items:center; justify-content:center; ">
                                <button class=" btn btn-sm "><i class="bi bi-file-earmark-plus" style="font-size: 28px;"></i></button>
                            </td>
                            <td>
                                <div style="display:flex; align-items:center; justify-content:center;">
                                    <button class="btn btn-sm" style="margin-right: 10px;"><i class="bi bi-clipboard-plus" style="font-size: 28px;"></i></button>
                                    <button class="btn btn-sm"><i class="bi bi-clipboard-data" style="font-size: 28px;"></i></button>
                                </div>
                            </td>
                            <td>
                                <div style="display:flex; align-items:center; justify-content:center;">
