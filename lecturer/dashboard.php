                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center;">
                                        <button class="btn btn-sm" title="Add New True False Quiz" style="margin-right: 10px;"><i class="bi bi-clipboard-plus" style="font-size: 28px;"></i></button>
                                        <button class="btn btn-sm" title="View True False Result"><i class="bi bi-clipboard-data" style="font-size: 28px;"></i></button>
                                    </div>
                                </td>
                                <td>
                                    <div style="display:flex; align-items:center; justify-content:center;">
                                        <button class="btn btn-sm" title="Add New Objective Quiz" style="margin-right: 10px;"><i class="bi bi-clipboard-plus" style="font-size: 28px;"></i></button>
